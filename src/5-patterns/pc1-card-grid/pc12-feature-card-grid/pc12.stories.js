...
import { createPC12 } from "./component";
...
export default {
	title: "Patterns/Card Grids/Feature Card Grid",
	parameters: {
		docs: {
			description: {
...
const Template = (args) => createPC12(args);

export const FeatureCardGrid = Template.bind({});
