export const createH12 = () => {

  return `
<div class="act-hero-row__links">
  <div class="act-hero-row__links__container">
    <div class="act-col__cw-8">
      <div class="act-box">
        <h1>Homepage Link Row</h1>
        <h5>H5 Subheading</h5>
  ...
  <div class="act-hero-row__links__background">
    <div class="act-col__cw-8">
      &nbsp;
    </div>
    <div class="act-col__cw-4 act-col__bgimg">
      &nbsp;
    </div>
  </div>
</div>
