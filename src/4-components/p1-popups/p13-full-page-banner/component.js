export const createP13 = ({
  ...
  return `
<div class="act-full-page-banner">
  <div class="act-full-page-banner__container">
    <div class="act-full-page-banner__content">
	 <img src="/images/have_your_say.png" alt="Image" class="item" />
	</div>
	<div class="act-full-page-banner__content">
	<div class="demo-content">
		<p class="demo-content__title">Have Your Say</p>
